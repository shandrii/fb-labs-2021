...
print("k: ", k)
S = sign(k, A_secret_keys[2], A_open_keys[0])
print("S: ", S)

k_1, S_1 = send_key(k, B_open_keys[1], B_open_keys[0], S)
print("k_1: ", k_1)
print("S_1: ", S_1)
k, S_recieved = recieve_key(k_1, S_1, B_secret_keys[2], B_open_keys[0])
print("k: ", k)
print("Recieved S: ", S_recieved)

if k == verify_sign(S, A_open_keys[1], A_open_keys[0]):
    print("Key verified!")
else:
